                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group row">
                                <label for="business_name" class="col-sm-4 col-form-label text-md-right">{{ __('Business Name') }}</label>
                            ...
                            <div class="form-group row">
                                <label for="business_name" class="col-sm-4 col-form-label text-md-right">{{ __('Business Address') }}</label>

                                <div class="col-md-6">
                                    <input id="business_address" type="text" class="form-control{{ $errors->has('business_address') ? ' is-invalid' : '' }}" name="business_address" value="{{ old('business_address') }}">
                            ...
                            <div class="form-group row">
                                <label for="password" class="col-md-4 col-form-label text-md-right">{{ __('Repeat Password (*)') }}</label>
